...
class GetVueloByIdHandlerTest {
	...
	@Mock GetVueloByIdQuery getVueloByIdQueryTest;
	...
	void init() throws Exception {
		...
		when(_vueloRepositoryTest.FindByIdAsync(any())).thenReturn(CompletableFuture.completedFuture(vueloTest));
		
	}
	
	@Test
	void GetVueloById() throws Exception {
		Future<VueloDTO> resultado = getVueloByIdHandler.Handle(getVueloByIdQueryTest);
