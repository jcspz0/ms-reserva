...
class CrearPasajeroHandlerTest {
	...
	@Mock
	CrearPasajeroCommand crearPasajeroCommandTest;
	...
	void init() throws Exception {
		...
		crearPasajeroHandlerTest =
			new CrearPasajeroHandler(_pasajeroRepository, _unitOfWork);

		when(crearPasajeroCommandTest.getNombre()).thenReturn(NombreTest);
		when(crearPasajeroCommandTest.getPrimerApellido())
			.thenReturn(PrimerApellidoTest);
		when(crearPasajeroCommandTest.getSegundoApellido())
			.thenReturn(SegundoApellidoTest);
	...
	void CrearPasajeroHandler() throws Exception {
		Future<UUID> result = crearPasajeroHandlerTest.Handle(
			crearPasajeroCommandTest
		);
