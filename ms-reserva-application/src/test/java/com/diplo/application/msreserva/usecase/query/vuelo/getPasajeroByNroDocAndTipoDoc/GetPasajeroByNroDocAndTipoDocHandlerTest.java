...
class GetPasajeroByNroDocAndTipoDocHandlerTest {
	...
	@Mock GetPasajeroByNroDocAndTipoDocQuery getPasajeroByNroDocAndTipoDocQuery;
	...
	void init() throws Exception {
		...
		getPasajeroByNroDocAndTipoDocHandler = new GetPasajeroByNroDocAndTipoDocHandler(_pasajeroRepository);
		...
		when(getPasajeroByNroDocAndTipoDocQuery.getNroDoc()).thenReturn(NroDocTest);
		when(getPasajeroByNroDocAndTipoDocQuery.getTipoDoc()).thenReturn(TipoDocTest);
		when(_pasajeroRepository.GetPasajeroByNroDocAndTipoDoc(anyInt(),anyInt())).thenReturn(CompletableFuture.completedFuture(pasajeroTest));
		
	}
	
	@Test
	void GetPasajeroByNroDocAndTipoDoc() throws Exception {
		Future<PasajeroDTO> resultado = getPasajeroByNroDocAndTipoDocHandler.Handle(getPasajeroByNroDocAndTipoDocQuery);
		
		assertNotNull(resultado);
		assertEquals(resultado.get().getNroDoc(), pasajeroTest.getDocumento().getNroDoc());
	}
