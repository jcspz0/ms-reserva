...
public class GetReservaByIdHandler implements IRequestHandler<GetReservaByIdQuery, ReservaDTO>{
	...
	@Override
	public Future<ReservaDTO> Handle(GetReservaByIdQuery request) throws Exception {
		
		ReservaDTO reservaDto = null;
		
		CompletableFuture<Reserva> objReserva =  (CompletableFuture<Reserva>) _reservaRepository.FindByIdAsync(request.getId());
