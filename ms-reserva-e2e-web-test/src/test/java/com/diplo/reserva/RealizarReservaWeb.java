...
public class RealizarReservaWeb {
	...
	@Before
	public void setUp() {
		System.setProperty("webdriver.gecko.driver", "E:\\jc\\postgrado\\programas\\geckodriver");
	...
	@Given("con el destino {string}, realizar la reserva al cliente {string} {string} {string} con idenficacion {int}, {int} con el precio de {double} y la cantidad de pasajeros {int}")
	public void obtenerDatosParaWeb(String inputDestino, String inputNombre, String inputPrimerApellido,
			String inputSegundoApellido, int inputNroDoc, int inputTipoDoc, double inputPrecio,
	...
	public void cargarDatosVueloParaWeb() throws Throwable {
		...
		Thread.sleep(2000);
		WebElement botonBuscarVuelo = driver.findElement(By.id("botonBuscarVuelo"));
		botonBuscarVuelo.click();
		Thread.sleep(5000);
		List<WebElement> tablaVuelos = driver.findElements(By.id("tbodyVuelos"));
		List<WebElement> filas = tablaVuelos.get(0).findElements(By.tagName("tr"));
		WebElement botonSeleccionar;
		WebElement cantidadAsientos;
		for (WebElement fila : filas) {
			cantidadAsientos = fila.findElement(By.id("tablaasientos"));
			if (Integer.valueOf(cantidadAsientos.getText()) >= cantidadPasajero) {
				botonSeleccionar = fila.findElement(By.id("tablabotonseleccionar"));
	...
	public void cargarDatosPasajero() throws InterruptedException {
		if (vueloEncontrado) {
			...
			//---------
			WebElement buscartipodoc = driver.findElement(By.id("inputbuscartipodoc"));
			buscartipodoc.click();
			WebElement seleccionartipodoc = driver.findElement(By.id("tipodoc"+tipoDoc));
			seleccionartipodoc.click();
			//---------
			WebElement botonbuscarpasajero = driver.findElement(By.id("botonbuscarpasajero"));
			botonbuscarpasajero.click();
			// ----------
			List<WebElement> tablapasajero = driver.findElements(By.id("tbodypasajero"));
			List<WebElement> filas = tablapasajero.get(0).findElements(By.tagName("tr"));
			WebElement botonSeleccionar;
			for (WebElement fila : filas) {
				if (!fila.findElements(By.id("tablabotonseleccionarpasajero")).isEmpty()) {
					botonSeleccionar = fila.findElement(By.id("tablabotonseleccionarpasajero"));
					botonSeleccionar.click();
			...
			if (!pasajeroEncontrado) {
				WebElement habilitarcrearpasajero = driver.findElement(By.id("habilitarcrearpasajero"));
				habilitarcrearpasajero.click();
				Thread.sleep(2000);
				WebElement inputCrearNroDoc = driver.findElement(By.id("inputCrearNroDoc"));
				...
				//-------------------
				WebElement inputcreartipodocvalue = driver.findElement(By.id("inputcreartipodocvalue"));
				inputcreartipodocvalue.click();
				WebElement creartipodoc = driver.findElement(By.id("creartipodoc"+tipoDoc));
				creartipodoc.click();
				//-------------------
				WebElement inputCrearNombre = driver.findElement(By.id("inputCrearNombre"));
				inputCrearNombre.sendKeys(nombre);
				WebElement inputCrearPrimerApellido = driver.findElement(By.id("inputCrearPrimerApellido"));
				inputCrearPrimerApellido.sendKeys(primerApellido);
				WebElement inputcrearsegundoapellido = driver.findElement(By.id("inputCrearSegundoApellido"));
	...
	public void crearReservaWeb() throws Exception {
		if(pasajeroEncontrado) {
			...
			paginareserva.click();
			WebElement inputCrearNroReserva = driver.findElement(By.id("inputCrearNroReserva"));
			inputCrearNroReserva.sendKeys(nroReserva);
			WebElement inputCrearPrecio = driver.findElement(By.id("inputCrearPrecio"));
			inputCrearPrecio.sendKeys(String.valueOf(precio));
			WebElement inputCrearCantidadPasajero = driver.findElement(By.id("inputCrearCantidadPasajero"));
			inputCrearCantidadPasajero.sendKeys(String.valueOf(cantidadPasajero));
			WebElement botoncrearreserva = driver.findElement(By.id("botoncrearreserva"));
			Thread.sleep(2000);
