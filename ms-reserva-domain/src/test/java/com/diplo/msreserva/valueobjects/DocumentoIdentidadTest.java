...
class DocumentoIdentidadTest {
	...
	void CrearDocumentoIdentidadCI() throws Exception {
		int nro = 123;
		int tipo = 1;
		String mostrarDocumentoIdentidad = "Numero de documento: " + nro + " , Tipo de documento: Carnet de identidad";
		
		DocumentoIdentidad documentoIdentidad = new DocumentoIdentidad(nro, tipo);
		assertEquals(nro, documentoIdentidad.getNroDoc());
		assertEquals(tipo, documentoIdentidad.getTipoDoc());
		assertEquals(mostrarDocumentoIdentidad, documentoIdentidad.getDocumentoIdentidad());
	}
	...
	void CrearDocumentoIdentidadPasaporte() throws Exception {
		int nro = 123;
		int tipo = 2;
		String mostrarDocumentoIdentidad = "Numero de documento: " + nro + " , Tipo de documento: Pasaporte";
