...
public class MsReservaWebApiService {
	...
	private void registrarHandlers() {
		CrearReservaHandler _CrearReservaHandler = new CrearReservaHandler(_serviceInfra.getService().getReservaService(), _serviceInfra.getService().get_ReservaFactory(),_serviceInfra.getReservaRepository() ,_serviceInfra.get_unitOfWork());
		_mediator.registrarComando(new CrearReservaCommand(), _CrearReservaHandler);
		GetReservaByIdHandler _getReservaByIdHandler = new GetReservaByIdHandler(_serviceInfra.getReservaRepository());
		...
		CrearVueloHandler _crearVueloHandler = new CrearVueloHandler(_serviceInfra.getVueloRepository(),_serviceInfra.get_unitOfWork());
		...
		GetVuelosByDestinoHandler _getVuelosByDestinoHandler = new GetVuelosByDestinoHandler(_serviceInfra.getVueloRepository());
		...
		GetVueloByIdHandler _getVueloByIdHandler = new GetVueloByIdHandler(_serviceInfra.getVueloRepository());
		...
		GetReservasByHoraAndEstadoHandler _GetReservasByHoraAndEstadoHandler = new GetReservasByHoraAndEstadoHandler(_serviceInfra.getReservaRepository());
		_mediator.registrarComando(_GetReservasByHoraAndEstadoQuery, _GetReservasByHoraAndEstadoHandler);
	
		CrearPasajeroCommand _CrearPasajeroCommand = new CrearPasajeroCommand();
		CrearPasajeroHandler _CrearPasajeroHandler = new CrearPasajeroHandler(_serviceInfra.getPasajeroRepository(), _serviceInfra.get_unitOfWork());
		_mediator.registrarComando(_CrearPasajeroCommand, _CrearPasajeroHandler);
		
		GetPasajeroByNroDocAndTipoDocQuery _GetPasajeroByNroDocAndTipoDocQuery = new GetPasajeroByNroDocAndTipoDocQuery();
		GetPasajeroByNroDocAndTipoDocHandler _GetPasajeroByNroDocAndTipoDocHandler = new GetPasajeroByNroDocAndTipoDocHandler(_serviceInfra.getPasajeroRepository());
		_mediator.registrarComando(_GetPasajeroByNroDocAndTipoDocQuery, _GetPasajeroByNroDocAndTipoDocHandler);
	}
