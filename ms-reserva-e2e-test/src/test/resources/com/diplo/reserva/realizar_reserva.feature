...
Feature: Realizar Reserva
  ...
  Scenario Outline: Como operador del sistema quiero crear una reserva con los datos del cliente para entregarle su codigo identificador de reserva
    Given dado el origen "<origen>" y destino "<destino>", realizar la reserva al cliente "<nombre>" "<primer_apellido>" "<segundo_apellido>" con idenficacion <nrodoc>, <tipodoc> con el precio de <precio> y la cantidad de pasajeros <cantidad_pasajeros>
    ...
    Examples: 
      ...
      | lapaz   |	santa		| juan   | perez           | pereza           |     1	 |       1 |    100 |                  1 |         200 |
