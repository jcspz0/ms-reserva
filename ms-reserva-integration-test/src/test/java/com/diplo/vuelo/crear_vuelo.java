...
public class crear_vuelo {
	...
	@Given("Se crea el vuelo con el numero de vuelo {int}, cantidad de asientos disponibles {int} y el destino {string}")
	public void given(int inputNroVuelo, int inputAsientos, String inputDestino) throws Throwable {
	...
	public void when() throws Throwable {
		...
		resultadoRest = client.post().uri("/vuelo/crear")
	...
	@Then("Se obtiene una respuesta correcta con codigo {int} de la creacion del vuelo")
