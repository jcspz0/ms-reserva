...
public class crear_reserva {
	...
	@Given(
		"Se crea la reserva con el nro de reserva {string}, pasajero {string}, vuelo {string}, precio de {double} y cantidad de pasajeros {int}"
	)
	public void given(
		String inputNroReserva,
		String inputPasajeroId,
		String inputVueloId,
		double inputPrecio,
