...
public class crear_pasajero {
	...
	@Given("Se crea el pasajero con el numero de documento {int}, tipo de documento {int}, nombre {string}, apellido paterno {string} y apellido materno {string}")
	public void given(int inputNroDoc, int inputTipoDoc, String inputNombre, String inputPrimerApellido, String inputSegundoApellido) throws Throwable {
		nroDoc = inputNroDoc; 
		...
		request = new PasajeroDTO(nroDoc, tipoDoc, nombre, primerApellido, segundoApellido);
	...
	public void when() throws Throwable {
		...
		resultadoRest = client.post().uri("/pasajero/crear")
	...
	@Then("Se obtiene una respuesta correcta con codigo {int} de la creacion del pasajero")
